    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div
                ...
                className="rounded-3xl border border-emerald-500/20 bg-emerald-500/5 p-6 backdrop-blur-md"
            >
            ...
            <motion.div
                ...
                className="rounded-3xl border border-rose-500/20 bg-rose-500/5 p-6 backdrop-blur-md"
            >
                ...
                <div className="flex flex-wrap gap-2">
                    {missingSkills.map((skill, index) => (
                        <span
                            key={index}
                            className="px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 text-sm font-medium decoration-rose-500/50"
                        >
                            {skill}
                        </span>
                    ))}

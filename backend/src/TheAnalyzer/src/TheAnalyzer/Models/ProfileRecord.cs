...
public class ProfileRecord
{
    ...
    /// <summary>
    /// Job Title associated with the analysis
    /// </summary>
    [DynamoDBProperty]
    public string? JobTitle { get; set; }

    /// <summary>
    /// Company associated with the analysis
    /// </summary>
    [DynamoDBProperty]
    public string? Company { get; set; }

    /// <summary>
    /// Computed session name for display
    /// </summary>
    [DynamoDBProperty]
    public string? SessionName { get; set; }
    
    /// <summary>
    /// Helper method to initialize keys and timestamps before saving
    /// </summary>
